...
const ENDPOINT = "http://localhost:8000"; //process.env.REACT_APP_SERVER_URL
      ...
      {activeChat ? (
        <div className={props.className}>
          ...
          <div className="absolute left-[31%] bottom-[8%]">
            ...
            <div className="border-[1px] border-[#aabac8] px-6 py-3 w-[560px] sm:w-[400px] md:w-[350px] h-[50px] lg:w-[400px] rounded-t-[10px]">
              <form
